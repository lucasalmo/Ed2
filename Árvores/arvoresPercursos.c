...
// Função para exibir a árvore no percurso pré-ordem considerando a idade
...
// Função para exibir a árvore no percurso pós-ordem considerando a idade
...
int main() {
    ...
    printf("\nUsuários em pré-ordem considerando a idade:\n");
    exibirPreOrdem(root);

    // Exibindo usuários em pós ordem
    printf("\nUsuários em pós-ordem considerando a idade:\n");
    exibirPosOrdem(root);
